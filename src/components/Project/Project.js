                ...
                <div className="row">
                    <div className="flex-item Project-1 col s12 m12 l10 offset-l1">
                        <div className="hoverTag">
                            <h4>Kiskis</h4>
                            <h5>Full-Stack</h5>
                            <a href="https://lit-escarpment-01189.herokuapp.com/" className="waves-effect waves-light btn-small">Visit Site</a>
                ...
                <div className="row">
                    <div className="flex-item Project-2 col s12 m12 l5 offset-l1">
                        <div className="hoverTag">
                            <h4>Brew Me</h4>
                            <h5>JavaScript</h5>
                            <a href="https://brandon-maxwell.github.io/BREW_ME/" className="waves-effect waves-light btn-small">Visit Site</a>
                    ...
                    <div className="row">
                        <div className="flex-item Project-3 col s12 m12 l5">
                            <div className="hoverTag">
                                ...
                                <h5>JavaScript</h5>
                                <a href="https://brandon-maxwell.github.io/Weather-Dashboard/" className="waves-effect waves-light btn-small">Visit Site</a>
                                <a href="https://github.com/brandon-maxwell/Weather-Dashboard" className="waves-effect waves-light btn-small">See on GitHub</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="flex-item Project-4 col s12 m12 l5 offset-l1">
                            <div className="hoverTag">
                                ...
                                <h5>JavaScript</h5>
                                <a href="https://brandon-maxwell.github.io/Day-Planner/" className="waves-effect waves-light btn-small">Visit Site</a>
                                <a href="https://github.com/brandon-maxwell/Day-Planner" className="waves-effect waves-light btn-small">See on GitHub</a>
                            </div>
                        </div>
                        ...
                        <div className="row">
                            <div className="flex-item Project-5 col s12 m12 l5 ">
                                <div className="hoverTag">
                                    ...
                                    <a href="https://aqueous-springs-60277.herokuapp.com/" className="waves-effect waves-light btn-small">Visit Site</a>
